document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    progressBar.style.width = `${ 100* (quiz.currentQuestionIndex+1) /questions.length }%`; // This value is hardcoded as a placeholder
    ...
    // Loop through the current question `choices`.
      ...
      */
        ...
        question.choices.forEach((currentChoise) => {
          
          let choicesInput = document.createElement("input");
          choicesInput.type = "radio";
          choicesInput.name = "choice";
          choicesInput.value = currentChoise;   

          let choiceLabel = document.createElement('label');
          choiceLabel.innerText = currentChoise;
  ...
  function nextButtonHandler () {
   ...
   allChoices.forEach((currentChoise) => {
    if(currentChoise.checked){

      selectedAnswer = currentChoise.value;
      let beforeValue = quiz.correctAnswers;
